...
Image::Image(unsigned int iWidth, unsigned int iHeight, vector<unsigned char>& vImageData, unsigned int iStreamId, const string& sTimestamp, const string& sResult)
{
	this->_iWidth = iWidth;
...
const vector<unsigned char>& Image::getImageData() const {
	return _vImageData;
}

void Image::setImageData(const vector<unsigned char>& imageData) {
